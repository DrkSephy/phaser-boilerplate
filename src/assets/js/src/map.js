function Map(game) {
  ...
  var _class = {};
      ...
      _class.getTileProperties = getTileProperties;
      // properties
  ...
  function init() {
    ...
    // Get a random tile and check the custom properties
    var tile = _map.getTile(5,5)
    console.log(tile.properties.Test);
  ...
  function getTileProperties(tile) {
    ...
    var newTile = _map.getTile(tile.x, tile.y);
    console.log(newTile.properties);
    return newTile.properties;
  }
