var Player = (function () {
  ...
  function update(isUpPressed, isRightPressed, isDownPressed, isLeftPressed, isAPressed) {
    //  console.log(this.walkingDirection);
    if(this.isOnTile()) {
      ...
      if(isAPressed) {
        ...
        var property = this.mapReference.getTileProperties(tileUp);
